              ...
              <div className="row">
                ...
                <div className="col-md-10 col-xl-10 my-3 surface">
                  <div className="head-flat d-flex justify-content-start align-items-center flex-wrap gap-2">
                    ...
                    <Link className="btn btn-outline-primary btn-sm" to="/users_create">إضافة مستخدم</Link>
                  </div>
                          ...
                          paginatedUsers.map(u => (
                            <tr key={u.id}>
                              ...
                              <td>{departments.find(d => d.department_id === u.department_id)?.department_name}</td>
                               {!isUser && (
                                <td>
                                  <i className="fas fa-pen text-primary" onClick={() => navigate(`/users_edit/${u.employee_id}`)}></i>
                                </td>
                              )}
                              {!isUser && (
                                <td>
