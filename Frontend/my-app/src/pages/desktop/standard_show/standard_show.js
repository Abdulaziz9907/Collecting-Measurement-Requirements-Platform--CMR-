...
//     await fetch(`${API_BASE}/api/standards/${id}/attachments`, {
//       method: 'POST',
//       body: form,
//     });
//     loadData();
...
//     await fetch(`${API_BASE}/api/standards/${id}/attachments/${attId}`, {
//       method: 'DELETE',
//     });
//     loadData();
//   };
...
//     attachments.filter(a => a.proof_name === name);
...
//   const proofs = (standard.proof_required || '')
//     .split(',')
//     .filter(Boolean);
...
//                       className="form-control"
//                       type="text"
//                       value={standard.standard_requirments}
//                       readOnly
//                     />
//                   </div>
//                   <div className="mb-3">
...
//                         type="text"
//                         value={standard.rejection_reason}
//                         readOnly
//                       />
//                     </div>
//                   )}
...
//                               input.multiple = true;
//                               input.onchange = e =>
//                                 handleSelectFiles(p, e.target.files);
//                               input.click();
//                             }}
//                           >
//                             رفع ملفات
...
//                   {user?.role?.toLowerCase() !== 'user' &&
//                     proofs.length === attachments.length && (
